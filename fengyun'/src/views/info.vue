      ...
      <van-dialog v-model="showHideOnBlur" :showConfirmButton="false" :closeOnClickOverlay="true">
        ...
        <div class="dialogContent">
          <div class="content">
            ...
            <span>2、风云榜分为活动期间的总排行榜（简称“总榜”）和每日排行榜（简称“日榜”）。</span>
            <span>3、活动期间总榜的前70名用户和日榜的前10名用户均可获得奖励（若出借金额相同时，以出借时间较早者优先排名获奖），每日排名将于当日0:00更新，可点击“查看往期排名”，查看中奖记录。</span>
            <span>4、兑奖时间为2019年10月9日-2019年10月12日16点，和掌柜客服将每日通知前一日中奖用户信息，并于节后统一兑奖，若超过活动兑奖时间，恕不兑奖。</span>
            <span>5、如有疑问请致电和掌柜客服电话400-020-0178或添加和掌柜客服微信号（a139lc）进行咨询。</span>
          </div>
        </div>
      </van-dialog>
    </div>
